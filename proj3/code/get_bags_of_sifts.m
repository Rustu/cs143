% Starter code preparetabsd by James Hays for CS 143, Brown University
...
% Plan:
%   -for each image
%       -init empty 1xD matrix of 'vocab scalars'
%       -find sift features in image, cluster to nearest vocab neighbor,
%       and increment that centroid's scalar in the 1xD matrix
